...
const SidebarExpended = () => {
  ...
  return (
    <div className={!isSideBarOpen && "hidden"}>
      ...
      ></div>
      <div className=" border dark:border-none flex  flex-col w-[15rem]  h-full overflow-y-scroll overflow-x-hidden absolute top-0 left-0 bg-white z-20 dark:bg-zinc-900 dark:text-white">
              ...
              <img
                src={
                  theme === "light"
                    ...
                    : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTz_0hffKfpWyYa0ZuLeHOOmkEQBluL2o1NdQ&usqp=CAU"
                }
                alt="logo"
                title="logo"
                className="w-28 pl-3 "
...
export default SidebarExpended;
